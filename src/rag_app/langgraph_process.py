...
from query_rag import PROMPT_TEMPLATE
...
retriever_tool = create_retriever_tool(
    ...
    "Busca y retorna información sobre la documentación previamente cargada en la base de datos.",
)
...
def rewrite(state):
    ...
    msg = [
        HumanMessage(
            content=f""" \n 
    Mire la entrada e intente razonar sobre la intención/significado semántico subyacente. \n 
...
if __name__ == "__main__":
    ...
    img =Image(graph.get_graph().draw_mermaid())
